...
from .views import api_list_techs, api_delete_tech, api_list_appointments, api_update_appointment, api_cancel_app, api_finish_app
...
urlpatterns = [
    ...
    path("appointments/<int:pk>/finish", api_finish_app, name="finished_app"),
]
