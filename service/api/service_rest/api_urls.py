...
from .views import api_list_techs, api_delete_tech, api_list_appointments, api_update_appointment
...
urlpatterns = [
    ...
    path("appointments/<int:pk>/cancel/", api_update_appointment, name="cancel_an_app"),
